    ...
    <>
      ...
      >
        ...
        <div className="flex h-16 items-center justify-between px-4 border-b border-zinc-200 dark:border-zinc-800">
          ...
          <button
            onClick={onToggle}
            className="flex h-8 w-8 items-center justify-center rounded-lg text-zinc-500 hover:bg-zinc-200 dark:hover:bg-zinc-800 hover:text-zinc-900 dark:hover:text-zinc-200 transition-colors"
          ...
          {navItems.map((item) => {
            ...
            return (
              <button
                ...
                className={`group flex w-full items-center gap-3 rounded-2xl px-3 py-2.5 text-xs font-bold transition-all cursor-pointer ${
                  isActive
                    ? item.activeBg
